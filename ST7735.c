...
void ST7735_SetCursor(uint32_t newX, uint32_t newY){
  if((newX > 128) || (newY > 160)){       // bad input  if((newX > 20) || (newY > 15)){       // bad input
    return;                             // do nothing
  }
  StX = newX;
  StY = newY;
...
void ST7735_OutUDec(uint32_t n){
  ...
  if(StX>20){
    StX = 20;
    ST7735_DrawCharS(StX*6,StY*10,'*',ST7735_RED,ST7735_BLACK, 1); //ST7735_DrawCharS(StX*6,StY*10,'*',ST7735_RED,ST7735_BLACK, 1);
  }
}
...
void ST7735_OutChar(char ch){
  if((ch == 10) || (ch == 13) || (ch == 27)){
    StY++; StX=0;
    if(StY>160){							//if(StY>15)
      StY = 0;
    }
    ST7735_DrawString(0,StY,"                     ",StTextColor);
    return;
  }
  ST7735_DrawCharS(StX,StY,ch,ST7735_YELLOW,ST7735_BLACK, 1); // ST7735_DrawCharS(StX*6,StY*10,ch,ST7735_YELLOW,ST7735_BLACK, 1);
  StX++;																													//StX++;
  if(StX>128){						//if(StX>20){
    StX = 20;
    ST7735_DrawCharS(StX,StY,'*',ST7735_RED,ST7735_BLACK, 1);	// ST7735_DrawCharS(StX*6,StY*10,'*',ST7735_RED,ST7735_BLACK, 1);
  }
  return;
}
//********ST7735_OutString*****************
